...
//
const BotName = 'Bot@demo_ngki'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/demo_ngki/'; // Nama Instagramlu cok
const whatsapplu = '0857-8483-0497'; // Nomor whatsapplu cok
const kapanbotaktif = '24 Jam'; // Kapan bot lu aktif
const grupch1 = 'https://chat.whatsapp.com/EFxmRoWiYB1GOlogNBJAAh'; // OFFICIAL GRUP LU 1
const grupch2 = 'https://chat.whatsapp.com/EQtnLZu5lzD87Lq1w37x0O'; // OFFICIAL GRUP LU 2
//
const
{
   WAConnection,
...
conn.on('user-presence-update', json => console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@BloodSword`))
conn.on('message-status-update', json =>
{
   const participant = json.participant ? ' (' + json.participant + ')' : '' // participant exists when the message is from a group
   console.log(`[ ${moment().format("HH:mm:ss")} ] => bot by Root@BloodSword`)
})
